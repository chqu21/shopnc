...
class alipay{
    ...
    public function get_payurl()
    {
        ...
        $this->parameter['key'] 			=	$this->payment['payment_config']['alipay_key'];	//合作伙伴ID
        $this->parameter['_input_charset']  =	CHARSET;					//网站编码
        $this->parameter['notify_url'] 		=	SHOP_SITE_URL."/api/gold_payment/alipay/notify_url.php";	//通知URL
        $this->parameter['return_url'] 		=	SHOP_SITE_URL."/api/gold_payment/alipay/return_url.php";	//返回URL
  ...
  public function notify_verify() {
	...
	public function return_verify() {
		...
		$param['op']	= "";
		$param['key']	= $this->payment['payment_config']['alipay_key'];
		$param['sign_type'] = $_GET['sign_type'];
		$veryfy_url = $this->alipay_verify_url. "partner=" .$this->payment['payment_config']['alipay_partner']. "&notify_id=".$param["notify_id"];
		$veryfy_result  = $this->get_verify($veryfy_url);

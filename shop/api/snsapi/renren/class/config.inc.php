...
//包含配置信息
$data = require(BASE_PATH.DS.'cache'.DS.'setting.php');
//判读站外分析是否开启
...
$configrenren->redirecturi= SHOP_SITE_URL.DS.'index.php?act=member_sharemanage&op=share_renren';//你的获取code的回调地址，也是accesstoken的回调地址

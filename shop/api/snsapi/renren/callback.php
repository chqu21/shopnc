<?php
require_once (BASE_PATH.DS.'api'.DS.'snsapi'.DS.'renren'.DS.'class'.DS.'config.inc.php');
require_once (BASE_PATH.DS.'api'.DS.'snsapi'.DS.'renren'.DS.'class'.DS.'RenrenOAuthApiService.class.php');
require_once (BASE_PATH.DS.'api'.DS.'snsapi'.DS.'renren'.DS.'class'.DS.'RenrenRestApiService.class.php');

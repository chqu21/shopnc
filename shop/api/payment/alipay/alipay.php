...
class alipay{
    ...
    public function get_payurl(){
    	$this->parameter = array(
            ...
            'notify_url'	=> SHOP_SITE_URL."/api/payment/".$this->order['payment_code']."/notify_url.php",	//通知URL
            'sign_type'		=> 'MD5',						//签名方式
            'return_url'	=> SHOP_SITE_URL."/api/payment/".$this->order['payment_code']."/return_url.php",	//返回URL
            /* 业务参数 */

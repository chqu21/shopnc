        ...
        <form method="post" enctype="multipart/form-data" id="apply_form">
          <ul>
            <li>
              ...
              <div class="pt">
                <input class="w400 input_plain" type="text" name="group_name" id="group_name" value="<?php echo $output['group']['group_name'];?>" maxlength="50"/>
            ...
            <li>
              ...
              <div class="pt">
                <input class="w120 input_plain"  type="text" name="start_time" id="start_time" maxlength="20" value="<?php echo date("Y-m-d",$output['group']['start_time']);?>"/>
			...
			<li>
              ...
              <div class="pt">
                <input class="w120 input_plain"  type="text" name="end_time" id="end_time" maxlength="20" value="<?php echo date("Y-m-d",$output['group']['end_time']);?>"/>
            ...
            <li>
              ...
              <div class="pt">
				<input class="w60 input_plain"  type="text" name="original_price" id="original_price" maxlength="20" value="<?php echo $output['group']['original_price'];?>"/>
			...
			<li>
              ...
              <div class="pt">
				<input class="w60 input_plain"  type="text" name="group_price" id="group_price" maxlength="20" value="<?php echo $output['group']['group_price'];?>"/>
			...
			<li>
              ...
              <div class="pt">
				<input class="w60 input_plain"  type="text" name="buyer_count" id="buyer_count" maxlength="20" value="<?php echo $output['group']['buyer_count'];?>"/>
			...
			<li>
              ...
              <div class="pt">
				<input class="w60 input_plain"  type="text" name="buyer_limit" id="buyer_limit" maxlength="20" value="<?php echo $output['group']['buyer_limit'];?>"/>
			...
			<li>
              ...
              <div class="pt">
				<input type="radio" name="is_refund" value="1" <?php if($output['group']['is_refund']==1){ echo 'checked';}?> >&nbsp;是&nbsp;&nbsp;
				<input type="radio" name="is_refund" value="2" <?php if($output['group']['is_refund']==2){ echo 'checked';}?> >&nbsp;否
			  </div>
            </li>
			...
			<li>
              <div class="tit">已上传：</div>
              <div class="pt">
				<img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_GROUPBUY_PATH.DS.$output['group']['group_pic'];?>">
			  </div>
            </li>
			<li>
              <div class="tit">
              ...
              <div class="pt">
                <?php showEditor('group_help',htmlspecialchars_decode(stripslashes($output['group']['group_help'])),'600px','300px','','true',false);?>
              </div>
            </li>
			<li>
              <div class="tit">
              ...
              <div class="pt">
                <?php showEditor('group_intro',htmlspecialchars_decode(stripslashes($output['group']['group_intro'])),'600px','300px','','true',false);?>
              </div>
            </li>
          </ul>
          <div class="btn_box"> <span class="f_btn">
			<input type='hidden' name='group_id' value="<?php echo $output['group']['group_id'];?>">
			<input type='hidden' name='audit_state' value="<?php echo $output['group']['is_audit'];?>">
...
$(function(){
    ...
    $("#apply_form").validate({
        rules: {
			...
			<?php if(empty($output['group']['group_pic'])){?>
			groupbuy_pic:{
				required:true,

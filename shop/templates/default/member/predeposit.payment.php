...
<div class="con">
  <div class="form_box">
	<form id="basic_info" method="post" action="<?php echo BASE_SITE_URL;?>/index.php?act=memberpredeposit&op=payment">
	  <ul>
	  	<li>
		  ...
		  <div class="pt">
			<select name="payment" class="select-box">
				...
				<option value="<?php echo $val['payment_id'];?>" <?php if($val['payment_id']==$output['charge']['payment']){ echo 'selected';}?>><?php echo $val['payment_name'];?></option>
				<?php }?>
				<?php }?>
			</select>
		...
		<li>
		  ...
		  <div class="pt">
			<input type="text" value="<?php echo $output['charge']['charge_price'];?>" id="charge_price" maxlength="24" class="input_plain c2 focus" name="charge_price">
		...
		<li>
		  ...
		  <div class="pt">
			<textarea id="J_sign" class="tp c2" rows="5" cols="" name="charge_des"><?php echo $output['charge']['charge_des'];?></textarea>
		  </div>
		</li>
	  </ul>
	  <div class="btn_box"> <span class="f_btn">
		<input type="hidden" name="pre_id" value="<?php echo $output['charge']['pre_id'];?>">

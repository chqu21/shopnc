        ...
        <form method="post" enctype="multipart/form-data" id="apply_form">
          <ul>
            <li>
              ...
              <div class="pt">
                <input class="w400 input_plain" type="text" name="goods_name" id="goods_name" maxlength="50" value="<?php echo $output['goods']['goods_name'];?>"/>	
            ...
            <li>
              ...
              <div class="pt">
                <input class="w120 input_plain"  type="text" name="goods_price" id="goods_price" maxlength="20" value="<?php echo $output['goods']['goods_price'];?>"/>
            ...
            <li>
              <div class="tit"><label for="">已上传：</label></div>
              <div class="pt">
				<img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_GOODS_PATH.DS.$output['goods']['goods_pic'];?>" width="300px">		
			  </div>
            </li>
            <li>
              <div class="tit">
              ...
              <div class="pt">
                <textarea name="goods_content" style="width:350px;height:180px" maxlength="200"><?php echo $output['goods']['goods_content']; ?></textarea>
              </div>
            </li>
            <li>
              <div class="tit">
...
$(function(){
    $("#apply_form").validate({
        rules: {
			...
			<?php if(empty($output['goods']['goods_id'])){?>
			goods_pic:{
				required:true,
				accept:'jpg|png|gif'	
			}

...
<form method="post" enctype="multipart/form-data" action='<?php echo BASE_SITE_URL;?>/index.php?act=memberaccount&op=upload' id="form_avaster">
	<input type="hidden" name="form_submit" value="ok" />
	<div class="mainbox setup_box setup-avatar">
	  <div class="hd">
		<h3><?php echo $lang['nc_member_title_avatar'];?></h3>
	  </div>
	  <div class="con clearfix">
		<div class="avatar_box clearfix">
		  ...
		  <div class="avatar_photo">
			<ul>
			  <li class="photo_large"><img  class="avatar" alt="<?php echo $lang['nc_member_title_avatar'];?>" src="<?php if(!empty($output['member']['avatar'])){ echo BASE_SITE_URL.'/data/upload/shop/member/'.$output['member']['avatar'];}else{ echo SHOP_TEMPLATES_URL.'/images/lsimg/avatar_photo.png';}?>"></li>
			</ul>
		  </div>
...
<?php }else{ ?>
<form action="index.php?act=memberaccount&op=cut" id="form_cut" method="post">
	<div class="mainbox setup_box setup-avatar">
    <input type="hidden" name="form_submit" value="ok" />

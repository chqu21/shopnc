...
class Db{
	...
	public static function select($param, $obj_page = '', $host = 'slave'){
		...
		if (defined('MYSQL_RESULT_TYPE') && MYSQL_RESULT_TYPE === 1) $result_type = MYSQL_ASSOC;
	...
	public static function getCount($table, $condition = null, $host = 'slave'){
		...
		$result = mysql_fetch_array(self::query($sql,$host));
		return $result['count'];
	}

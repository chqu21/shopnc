...
function remote_ftp($path, $file, $ifdel = true){
	...
	if(!ftpcmd('error')) ftpcmd('upload', $image_full_path.'_max'.$_ext);
	if(!ftpcmd('error')) ftpcmd('upload', $image_full_path.'_mid'.$_ext);
	if(!ftpcmd('error')) ftpcmd('upload', $image_full_path.'_small'.$_ext);
	if(!ftpcmd('error')) ftpcmd('upload', $image_full_path.'_tiny'.$_ext);
	if(!ftpcmd('error')) ftpcmd('upload', $image_full_path.'_240x240'.$_ext);

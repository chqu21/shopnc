...
<div class="sidebar">
  <div class="my-info">
    <div class="avatar"><img class="t-img" src="<?php echo getMemberAvatarForCircle($output['cm_info']['member_avatar']);?>" /><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=memberaccount&op=avatar" title="<?php echo $lang['nc_edit_avatar'];?>"><?php echo $lang['nc_edit_avatar'];?></a></div>
    <dl>
      <dt>
        <h2><a href="javascript:void(0);"><?php echo $output['cm_info']['member_name'];?></a></h2>
      </dt>

...
<div class="choose-image">
  ...
  <div class="goods-gallery tabs-panel <?php if($_GET['curpage'] == ''){?>tabs-hide<?php }?>">
    ...
    <ul class="list">
      ...
      <li><a href="javascript:void(0);" nctype="chooseimage" data-param="{'img':'<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$_SESSION['member_id'].DS.$v['ap_cover'];?>'}"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$_SESSION['member_id'].DS.$v['ap_cover'].'_240x240.'.get_image_type($v['ap_cover']);?>" title='<?php echo $v['ap_name']?>'/>

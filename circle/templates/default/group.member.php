      ...
      <h3><?php echo $lang['circle_my_cart'];?></h3>
        <li>
          <dl class="member-info">
            <dt class="member-name"><a href="javascript:void(0);"><?php echo $output['cm_info']['member_name'];?></a></dt>
            <dd class="member-avatar-m"><img src="<?php echo getMemberAvatarForCircle($output['cm_info']['member_avatar']);?>" /></dd>

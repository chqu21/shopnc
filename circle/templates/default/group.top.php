...
<div class="group-top">
  <dl class="circle-info">
    ...
    <dd class="manage">
      <span class="master">
        <?php echo $lang['circle_manager'].$lang['nc_colon'];?><a href="javascript:void(0);" nctype="mcard" data-param="{'id':<?php echo $output['creator']['member_id'];?>}"><i></i><?php echo $output['creator']['member_name'];?></a>
      </span>
      <span class="moderator">
        ...
        <a href="javascript:void(0);"  nctype="mcard" data-param="{'id':<?php echo $val['member_id'];?>}"><i></i><?php echo $val['member_name'];?></a>

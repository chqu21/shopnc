    ...
    <ul class="search-theme-list">
      ...
      <li>
        <dl>
          ...
          <dd class="theme-sub"><span class="theme-avatar"><?php echo $lang['circle_theme_author'].$lang['nc_colon'];?><a href="javascript:void(0);"><?php echo $val['member_name'];?></a></span><span><?php echo $lang['circle_release_time'].$lang['nc_colon'];?><em><?php echo @date('Y-m-d', $val['theme_addtime']);?></em></span><span class="theme-group"><?php echo $lang['circle_come_from_group'].$lang['nc_colon'];?><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>"><?php echo $val['circle_name'];?></a></span></dd>

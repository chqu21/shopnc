...
<div class="homepage warp-all">
  ...
  <div class="layout-r">
    ...
    <dl class="member-no-login">
      <dd class="avatar"><img src="<?php  echo getMemberAvatarForCircle();?>" /> </dd>
      ...
      <dd class="quick-link"> <?php echo $lang['circle_login_prompt_one'];?><a href="javascript:void(0);" nctype="login" class="url">[<?php echo $lang['nc_login'];?>]</a><?php echo $lang['circle_login_prompt_two'];?><br/>
        <?php echo $lang['circle_register_prompt_one'];?><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=login&op=register" class="url">[<?php echo $lang['nc_register'];?>]</a><?php echo $lang['circle_register_prompt_one'];?></dd>
    </dl>
    <?php }else{?>
    <dl class="member-me-info">
      <dt class="member-name"><?php echo $_SESSION['member_name'];?></dt>
      <dd class="avatar"><img src="<?php  echo getMemberAvatarForCircle($_SESSION['avatar']);?>" /><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=memberaccount&op=avatar" title="<?php echo $lang['nc_edit_avatar'];?>"><?php echo $lang['nc_edit_avatar'];?></a></dd>
          ...
          <ul class="new-theme">
            ...
            <li>
              <dl>
                ...
                <dd class="member-avatar-s"><img src="<?php echo getMemberAvatarForCircle($v['member_avatar']);?>"/></dd>
                <dd class="theme-intro"><a href="javascript:void(0);" class="member-name" title="<?php echo $v['member_name'];?>"><?php echo $v['member_name'];?></a><span class="date"><?php echo @date('Y-m-d H:i', $v['theme_addtime']);?></span></dd>
              </dl>
            </li>
            <?php }?>
          </ul>
  ...
  <div class="warp-all recommend-group">
    ...
    <div class="content" nctype="order">
      ...
      <div class="good-member clearfix">
        ...
        <div class="contnet special">
          <dl class="member-info">
            <dt class="name"><a href="javascript:void(0);"><?php echo $output['one_member']['member_name'];?></a></dt>
            <dd class="avatar thumb"><a href="javascript:void(0);"><img src="<?php echo getMemberAvatarForCircle($output['one_member']['member_avatar']);?>"  class="t-img"/></a></dd>
        ...
        <div class="contnet normal">
          ...
          <dl class="member-info">
            ...
            <dd class="avatar"><a href="javascript:void(0);"><img src="<?php echo getMemberAvatarForCircle($val['member_avatar']);?>"/></a></dd>

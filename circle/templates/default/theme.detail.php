  ...
  <div class="base-layout mt20">
    <div class="mainbox">
      <div class="theme-detail-header">
        <div class="member-avatar-m"><img src="<?php echo getMemberAvatarForCircle($output['theme_info']['member_avatar']);?>"/></div>
        ...
        <div class="theme-info-a"> <a href="javascript:void(0);" nctype="mcard" data-param="{'id':<?php echo $output['theme_info']['member_id'];?>}"><?php echo $output['theme_info']['member_name'];?></a><span class="floor">(<?php echo $lang['circle_landlord'];?>)</span>
      ...
      <ul class="theme-reply-list">
        ...
        <li class="reply-info" id="f<?php echo $val['reply_id'];?>">
          <dl>
            ...
            <?php }?>
            <dd class="member-avatar-m"><img src="<?php echo getMemberAvatarForCircle($val['member_avatar']);?>" /></dd>
      ...
      <div class="quick-reply">
        ...
        <div class="quick-reply-member"><a id="quickReply"></a>
          <div class="member-avatar-m"><img src="<?php echo getMemberAvatarForCircle($output['cm_info']['member_avatar']);?>"/></div>
        </div>

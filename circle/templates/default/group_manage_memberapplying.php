    ...
    <table class="base-table-style">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><dl class="member-base"><dt class="name"><a href="javascript:void(0);"><?php echo $val['member_name'];?></a></dt><dd class="member-avatar-s"><img src="<?php echo getMemberAvatarForCircle($val['member_avatar']);?>" /></dd>
            </dl></td>

      ...
      <div class="<?php if($output['display_mode'] == 'preview'){?>read-model-preview<?php }else{?>read-model-list<?php }?>">
        ...
        <ul class="group-theme-list">
          ...
          <li nctype="li<?php echo $val['theme_id'];?>">
            ...
            <?php }?>
            <div class="theme-writer"><i title="<?php echo $lang['circle_author'];?>"></i><a href="javascript:void(0);" title="<?php echo $val['member_name'];?>"><?php echo $val['member_name'];?></a><?php echo memberIdentity($val['is_identity']);?></div>
            ...
            <div class="theme-lastspeak-name"><i title="<?php echo $lang['circle_lastspeak_member'];?>"></i><a href="javascript:void(0);" title="<?php echo $val['lastspeak_name'];?>"><?php echo $val['lastspeak_name'];?></a></div>

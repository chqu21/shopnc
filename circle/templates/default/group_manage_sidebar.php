...
<div class="my-info">
  <div class="avatar"><img src="<?php echo getMemberAvatarForCircle($_SESSION['avatar']);?>" /><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=memberaccount&op=avatar" title="<?php echo $lang['nc_edit_avatar'];?>"><?php echo $lang['nc_edit_avatar'];?></a></div>
  <dl>
    <dt>

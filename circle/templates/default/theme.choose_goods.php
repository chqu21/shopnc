...
<div class="choose-goods">
  ...
  <div class="goods-api tabs-panel">
    <label><i></i><?php echo $lang['circle_goods_link_tips1'].$lang['circle_goods_link_tips2'].$lang['circle_goods_link_tips3'];?></label>
    <p><input type="text" id="goods_link" class="text w400"/>
    <a href="javascript:void(0);" nctype="goodsLinkAdd"><?php echo $lang['nc_add'];?></a></p>
  </div>
  <div class="tabs-panel tabs-hide"> 
    ...
    <ul id="mycarousel1" class="jcarousel-skin-tango">
      ...
      <li><a href="javascript:void(0);" data-param="{'id':'<?php echo $v['goods_id'];?>','name':'<?php echo $v['goods_name'];?>','price':'<?php echo $v['goods_price'];?>','storeid':'<?php echo $v['store_id'];?>','img':'<?php echo thumb($v,'tiny');?>','image':'<?php echo $v['goods_image'];?>','uri':'<?php echo SHOP_SITE_URL.'/'.ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id']), 'goods');?>','type':0}"> <img title="<?php echo $v['goods_name']?>" src="<?php echo thumb($v,'small');?>"/>
  ...
  <div class="handle-bar"><a href="Javascript: void(0)" class="button" nctype="insertGoods"><?php echo $lang['circle_insert_theme'];?></a></div>
</div>
<script src="<?php echo RESOURCE_SITE_URL;?>/js/jcarousel/jquery.jcarousel.min.js"></script>
<script>
...
$(function(){
	...
	$('a[nctype="goodsLinkAdd"]').click(function(){
		...
		$.getJSON(_uri, function(data){
			if (data){
				$('<dd data-param="{\'id\':\''+data.id+'\',\'name\':\''+data.name+'\',\'price\':\''+data.price+'\',\'storeid\':\''+data.storeid+'\',\'img\':\''+data.img+'\',\'image\':\''+data.image+'\',\'uri\':\''+data.uri+'\',\'type\':\''+data.type+'\'}"><em></em><p><img src="'+data.img+'" /></p></dd>')

  ...
  <table class="table tb-type2 msg">
    <tbody class="noborder">
      <tr>
        ...
        <td class="tip"><span class="no_icon">
      ...
      <tr>
        <td><?php if (is_array($output['url'])){ foreach($output['url'] as $k => $v){ ?>
          ...
          <a href="<?php echo $output['url'];?>" class="btn"><span><?php echo $lang['nc_back_now'];?></span></a> 
          <script type="text/javascript"> window.setTimeout("javascript:location.href='<?php echo $output['url'];?>'", <?php echo $time;?>); </script>
          <?php }else { ?>
          <a href="javascript:history.back()" class="btn"><span><?php echo $lang['nc_back_to_pre_page'];?></span></a> 

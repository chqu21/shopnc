    ...
    <table class="table tb-type2">
      <thead>
        ...
        <tr class="thead">
		  ...
		  <th><?php echo $lang['nc_admin_belong_to_area'];?></th>
		  <th><?php echo $lang['nc_admin_area_store_num'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
		  ...
		  <td class='align-center'><a href="index.php?act=area&op=area_edit&area_id=<?php echo $val['area_id'];?>"><?php echo $lang['nc_edit'];?></a> | 

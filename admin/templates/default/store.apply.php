    ...
    <table class="table tb-type2">
      <thead>
        ...
        <tr class="thead">
          ...
          <th class="w48"><?php echo $lang['nc_admin_store_business_hour'];?></th>
          <th class="w200"><?php echo $lang['nc_admin_store_bus'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
		  ...
		  <td><?php echo $val['business_hour'];?></td>
		  <td><?php echo $val['bus'];?></td>
		  <td class='align-center'><a href='index.php?act=store&op=applycheck&store_id=<?php echo $val['store_id'];?>'><?php echo $lang['nc_check'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">

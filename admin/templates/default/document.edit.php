...
function add_uploadedfile(file_data)
{
    ...
    var newImg = '<tr id="' + file_data.file_id + '" class="tatr2"><input type="hidden" name="file_id[]" value="' + file_data.file_id + '" /><td><img width="40px" height="40px" src="<?php echo UPLOAD_SITE_URL.'/'.'article'.'/';?>' + file_data.file_name + '" /></td><td>' + file_data.file_name + '</td><td><a href="javascript:insert_editor(\'<?php echo UPLOAD_SITE_URL.'/'.'article'.'/';?>' + file_data.file_name + '\');"><?php echo $lang['document_index_insert'];?></a> | <a href="javascript:del_file_upload(' + file_data.file_id + ');"><?php echo $lang['nc_del'];?></a></td></tr>';

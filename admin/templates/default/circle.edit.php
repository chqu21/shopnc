  ...
  <form id="circle_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
            <label><input type="radio" name="c_status" <?php if($output['circle_info']['circle_status'] == 0){ echo 'checked="checked"';}?> value="0" /><?php echo $lang['close'];?></label>
            <label><input type="radio" name="c_status" <?php if($output['circle_info']['circle_status'] == 1){ echo 'checked="checked"';}?> value="1" /><?php echo $lang['open'];?></label>

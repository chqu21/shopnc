...
<div class="page">
  ...
  <form id="add_form" method="post" action="index.php?act=brand&op=brandedit" enctype="multipart/form-data">
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
          	<input type="text" id="brand_name" name="brand_name" class="txt" value="<?php echo $output['brand']['brand_name'];?>">
          </td>
        </tr>
        <tr>
          ...
          <td class="vatop rowform">
            <span class="type-file-show">
            	...
            	<div class="type-file-preview">
            		<img src="<?php echo BASE_SITE_URL.'/data/upload/'.(ATTACH_BRAND_PATH.DS.$output['brand']['brand_pic']);?>">
            	</div>
            </span>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="brand_sort" name="brand_sort" class="txt" value="<?php echo $output['brand']['brand_sort'];?>"></td>
        </tr>
		<tr>
          <td colspan="2">
        ...
        <tr class="noborder">
          <td class="vatop rowform">
			<textarea name="brand_des"><?php echo $output['brand']['brand_des'];?></textarea>
		  </td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
          <td colspan="2">
          	<input type="hidden" name="brand_id" value="<?php echo $output['brand']['brand_id'];?>">

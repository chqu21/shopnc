  ...
  <form id="link_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label for="sg_description"><?php echo $lang['nc_admin_website_adv_content'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
          	<textarea id="sg_description" name="ap_intro" class="tarea" ></textarea>
          </td>
          <td class="vatop tips"></td>
        </tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
          	<select name="ap_class" id="ap_class">
          	  <option value="2"><?php echo $lang['nc_admin_website_adv_pic'];?></option>
              <option value="1"><?php echo $lang['nc_admin_website_adv_words'];?></option> 
            </select>
		  </td>
      ...
      <tbody id="default_pic">
        <tr>
          <td colspan="2" class="required"><label class="validation" for="change_default_pic"><?php echo $lang['nc_admin_website_adv_pic']; ?></label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform type-file-box">
          	<input type="file" name="default_pic" id="change_default_pic" size="30" hidefocus="true" nc_type="change_default_pic">
          </td>
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="15" ><a href="JavaScript:void(0);" class="btn" id="submitBtn"><span><?php echo $lang['nc_save'];?></span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>

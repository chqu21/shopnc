...
function select_recommend_goods(goods_id){//商品选择
	...
	text_append += '<a href="'+SHOP_SITE_URL+'/index.php?act=goods&goods_id='+goods_id+'&id='+store_id+'" target="_blank">';
...
function update_adv_pic(id,ap_id){//更新图片
	var obj = $("#picture_"+id);
	$.get(SHOP_SITE_URL+'/index.php?act=adv&op=advshow&ap_id='+ap_id, function(data){

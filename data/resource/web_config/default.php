  ...
  <div class="nc-home-pattern style-<?php echo $output['style_name'];?>">
    <div class="rightbar">
      ...
      <ol class="saletop-list">
        ...
        <li class="top">
          <dl>
            ...
            <img src="<?php echo strpos($val['goods_pic'],'http')===0 ? $val['goods_pic']:UPLOAD_SITE_URL."/".$val['goods_pic'];?>" title="<?php echo $val['goods_name'];?>" onload="javascript:DrawImage(this,60,60);" target="_blank">
            </span></a></dd>
      ...
      <div class="ad-banner">
      	...
      	<script type="text/javascript" src="<?php echo SHOP_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=<?php echo $output['code_adv']['code_info']['ap_id'];?>"></script>
      	<?php }else { ?>
      	<a href="<?php echo $output['code_adv']['code_info']['url'];?>" target="_blank">
      	<img border=0 src="<?php  echo UPLOAD_SITE_URL.'/'.$output['code_adv']['code_info']['pic'];?>">
      	</a>
      	<?php } ?>
      </div>
    </div>
    <div class="leftbar">
      <div class="title">
      	...
      	<img border=0 src="<?php  echo UPLOAD_SITE_URL.'/'.$output['code_tit']['code_info']['pic'];?>" >
      	</a>
      	<?php }else { ?>
      	<img border=0 src="<?php  echo UPLOAD_SITE_URL.'/'.$output['code_tit']['code_info']['pic'];?>" >
      	<?php } ?>
      ...
      <div class="sale-pic">
      	...
      	<script type="text/javascript" src="<?php echo SHOP_SITE_URL;?>/index.php?act=adv&op=advshow&ap_id=<?php echo $output['code_act']['code_info']['ap_id'];?>"></script>
      	<?php }else { ?>
      	<a href="<?php echo $output['code_act']['code_info']['url'];?>" target="_blank">
      	<img border=0 src="<?php  echo UPLOAD_SITE_URL.'/'.$output['code_act']['code_info']['pic'];?>">
      	</a>
      	<?php } ?>
      </div>
    </div>
          ...
          <li>
            <dl>
              ...
              <dd class="goods-pic"><span class="thumb size120"><i></i>
              	<a target="_blank" href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$v['goods_id']),'goods'); ?>">
              	<img src="<?php echo strpos($v['goods_pic'],'http')===0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".$v['goods_pic'];?>" alt="<?php echo $v['goods_name']; ?>"  onload="javascript:DrawImage(this,120,120);" />
              	</a></span></dd>
      ...
      <ul class="brands">
        ...
        <li>
          <div class="brands-logo"><i></i><a href="<?php echo ncUrl(array('act'=>'brand','op'=>'list','brand'=>$val['brand_id'])); ?>" target="_blank">
          	<img src="<?php  echo UPLOAD_SITE_URL.'/'.$val['brand_pic'];?>" alt="<?php echo $val['brand_name']; ?>"  onload="javascript:DrawImage(this,88,44);"></a></div>

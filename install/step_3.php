...
<head>
<meta charset="utf-8">
<title><?php echo $htmll_title;?></title>
    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库密码</label>
          <span>
          <input type="text" name="db_pwd" maxlength="20" value="<?php echo $_POST['db_pwd'] ? $_POST['db_pwd'] : '';?>">
          </span> <em></em></div>
        <div>
          <label>数据库表前缀</label>
          <span>
		...
		<div>
          <label>&nbsp;</label>
          <input type="checkbox" name="demo_data" <?php echo ($_POST['demo_date']==1 ? 'checked':'');?> id="demo_data" value="1">
          <h4>演示数据</h4>
		</div>-->

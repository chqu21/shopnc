 ...
 *  Copyrights 2013-9-18 hjgang All rights reserved.
 */
public class MyImageSrcAsynaTask extends AsyncTask<String,Void,String>{
	private String themb;
	private ImageView iv;

	public MyImageSrcAsynaTask(String themb,ImageView iv){
		this.themb=themb;
		this.iv=iv;
	}
	@Override
			...
			ImageLoader.getInstance().asyncLoadBitmap(result, new ImageLoader.ImageCallback() {
				...
				public void imageLoaded(Bitmap bmp, String url) {
					if(bmp!=null){
						...
						iv.setImageResource(R.drawable.avatar_96);
					}
				}
			});
		}else{

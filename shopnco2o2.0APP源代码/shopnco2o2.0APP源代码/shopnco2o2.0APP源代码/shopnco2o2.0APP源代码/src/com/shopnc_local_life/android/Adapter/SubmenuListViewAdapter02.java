 ...
 * @author hjgang
 */
public class SubmenuListViewAdapter02 extends BaseAdapter {
	/**  */
	public static final String TAG_ITEM_TEXT = "text";
	/**  */
	public static final String TAG_ITEM_TEXT_ID = "icon";
	 ...
	 * @param ctx
	 */
	public SubmenuListViewAdapter02(Context ctx, ArrayList<HashMap<String, Object>> datas){
	...
	public long getItemId(int index) {
		...
		Integer icon_id = (Integer)item.get(TAG_ITEM_TEXT_ID);
		if(icon_id != null){

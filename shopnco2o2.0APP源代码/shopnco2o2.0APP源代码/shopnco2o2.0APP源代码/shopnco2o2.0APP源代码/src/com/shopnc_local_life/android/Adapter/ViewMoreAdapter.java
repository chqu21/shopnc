...
public class ViewMoreAdapter extends ArrayAdapter<String> {
	...
	public ViewMoreAdapter(Context context, List<String> listData, int sId, int nId) {
	...
	public ViewMoreAdapter(Context context, String[] arrayData, int sId, int nId) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		TextView view;
		if (convertView == null) {
			view = (TextView) LayoutInflater.from(mContext).inflate(R.layout.more_choose_item, parent, false);
		} else {

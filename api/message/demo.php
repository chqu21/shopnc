<?php
	...
	$phone = isset($_POST['phone'])?$_POST['phone']:exit('no phone');
	$text  = $_POST['text'];
	//$text  = iconv('GB2312','UTF-8',$_GET['text']);
	set_time_limit(0);
 ...
 * 网关地址
 */	
$gwUrl = 'http://sdk229ws.eucp.b2m.cn:8080/sdk/SDKService';


/**
 * 序列号,请通过亿美销售人员获取
 */
$serialNumber = '9SDK-EMY-0229-JCSLM';
...
function sendSMS()
{
	 ...
	 */
	$statusCode = $client->sendSMS(array($phone),$text);
	//echo "处理状态码:".$statusCode;
}
